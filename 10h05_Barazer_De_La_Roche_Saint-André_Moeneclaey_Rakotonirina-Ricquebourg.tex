...
\begin{figure}
\centering
\subfigure[$h$]{\includegraphics[width=2.5cm]{homo_unidirec_damier_2.png}}
\subfigure[$h_1$]{\includegraphics[width=2.5cm]{homo_unidirec_part_1_damier_2.png}}
\subfigure[$h_2$]{\includegraphics[width=2.5cm]{homo_unidirec_part_2_damier_2.png}}
...
\item On calcule $F_4$   
\item On calcule $f*\mathds{1}_{]-\frac{1}{2},\frac{1}{2}[}*\mathcal{G}_3^d$ grâce à $F_4$
\end{itemize}
\end{frame}
\begin{frame}{Illustration sur un sur-échantillonnage}
...
\begin{frame}
 ...
 \begin{figure}
   ...
   \hfill
   \subfigure[\scriptsize{Szeliski}]{\includegraphics[width=28mm]{lena_10_rotations_szeli.png}}
   \hfill
   \subfigure[\scriptsize{Yaroslavsky}]{\includegraphics[width=28mm]{lena_10_rotations_yaro.png}}
   \\
   \subfigure[\scriptsize{Linéaire}]{\includegraphics[width=28mm]{linear_10rot_lena.png}}
   \hfill
